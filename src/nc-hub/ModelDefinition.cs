...
/// </summary>
public class ModelDefinition : IValidateOptions<ModelDefinition>
{
	...
	/// <summary>
	/// Creates a new instance of <see cref="ModelDefinition"/> based on the provided <paramref name="type"/>.
	/// </summary>
	...
	/// </summary>
	public string FullName => $"{Solution.Name}.{ModelName}";

	/// <summary>
	/// Initializes a new instance of the <see cref="ModelDefinition"/> class using the type of the specified POCO
	/// (Plain Old CLR Object).
	/// </summary>
	/// <param name="poco">The object whose type will be used to define the class. Must not be <see langword="null"/>.</param>
	public ModelDefinition(object poco)
		: this(poco.GetType())
	{ }
	...
	/// <summary>
	/// Solution to which this model belongs.
	/// </summary>
	...
	/// </summary>
	public SafeString ModelName { get; set; } = default!;
	...
	public void Validate()
	{
		...
		if (BaseClass is not null && BaseClass.IsSealed)
			throw new ArgumentOutOfRangeException(nameof(BaseClass), BaseClass, "You cannot derive from a sealed class.");
		...
		foreach (var interfaceType in Interfaces)
		{
			foreach (var interfaceProperty in interfaceType.GetProperties())
			{
				if (!definedProps.TryGetValue(interfaceProperty.Name, out var match))
					throw new MissingMemberException(ModelName, interfaceProperty.Name);
	...
	/// </summary>
	/// <remarks>This method invokes the <see cref="ModelDefinition.Validate"/> method on the provided
	...
	public ValidateOptionsResult Validate(string? name, ModelDefinition options)
	{
		try
		{
			options.Validate();
...
public class ModelDefinition<T> : ModelDefinition where T : class
{
	public ModelDefinition()
		: base(typeof(T))
	{ }
...
/// <summary>
/// Provides a mechanism to compare two <see cref="ModelDefinition"/> objects for equality based on their solution and
/// class name.
/// </summary>
/// <remarks>This comparer considers two <see cref="ModelDefinition"/> objects equal 
...
public class ModelDefinitionComparer : IEqualityComparer<ModelDefinition>
{
	/// <summary>
	/// Determines whether two <see cref="ModelDefinition"/> instances are equal based on their properties.
	/// </summary>
	/// <param name="x">The first <see cref="ModelDefinition"/> instance to compare, or <see langword="null"/>.</param>
	/// <param name="y">The second <see cref="ModelDefinition"/> instance to compare, or <see langword="null"/>.</param>
	...
	/// <summary>
	/// Generates a hash code for the specified <see cref="ModelDefinition"/> object.
	/// </summary>
	...
	/// <param name="obj">The <see cref="ModelDefinition"/> object for which to generate the hash code. Cannot be <c>null</c>.</param>
	/// <returns>An integer hash code that represents the specified <see cref="ModelDefinition"/> object.</returns>
	public int GetHashCode(ModelDefinition obj)
	{
		var hash = new HashCode();

		hash.Add(obj.Solution.Name.Value, StringComparer.OrdinalIgnoreCase);
		hash.Add(obj.ModelName.Value, StringComparer.OrdinalIgnoreCase);
