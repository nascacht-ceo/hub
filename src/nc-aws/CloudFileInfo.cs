...
{
    private readonly CloudFileProvider _provider;
    ...
    /// </summary>
    public CloudFileInfo(CloudFileProvider provider, S3Object s3Object)
    {
        _provider = provider;
    ...
    /// </summary>
    public CloudFileInfo(CloudFileProvider provider, string path, GetObjectMetadataResponse metadataResponse)
    {
        _provider = provider;
    ...
    /// Constructor for files that don't exist.
    /// </summary>
    public CloudFileInfo(CloudFileProvider provider, string path)
    {
        _provider = provider;
        Name = path.Split('/').Last();
        Path = path;
